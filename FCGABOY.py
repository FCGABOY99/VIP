...
from FCGABOY import FCGABOY

__CHANNEL_USERNAME__ = "FCGABOY"
__GROUP_USERNAME__   = "FCGABOY"
...
def banner(console):
    ...
    console.print("[bold green]♕ FCGABOY[/bold green]: Car Parking Multiplayer Hacking Tool.")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if login_response != 0:
            ...
            console.print("[bold graaeen]SUCCESSFUL[/bold green].")
            sleep(2)
        while True:
            banner(console)
